...
namespace API.Repositories
{
    public class MySQLStablishmentRepository(IDbConnection connection) : IStablishmentRepository
    {
        ...
        {
            string sql = @"
SELECT susId, fantasyName, addressNumber, address, addressDistrict, phone, c.cityName, c.state, s.latitude, s.longitude, unitTypeCode, stablishmentTypeCode, contractWithSus, ln.natureDescription   
